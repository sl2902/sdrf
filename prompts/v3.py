...
{{
  ...
  "characteristics[sex]": "sex of study subjects. Return 'male', 'female', or Not Applicable. If both sexes present return 'male' here and 'female' in a second pass. Scan full text including patient demographics.",
  ...
  "factorvalue[phenotype]": "the experimental grouping variable if samples are compared by phenotype or clinical outcome e.g. 'normal', 'tumor', 'malignant', 'benign', 'indolent', 'aggressive', 'relapse', 'no relapse', 'before_treatment', 'treatment', 'control', 'infected'. Only fill if phenotype is the main experimental variable being compared, else Not Applicable",
}}
...
Example 1 — TMT labeling, lung cancer tissue, fractionated:
{{"characteristics[organism]": "Homo sapiens", "characteristics[organismpart]": "lung", "characteristics[sex]": "male", "characteristics[disease]": "squamous cell carcinoma", "characteristics[materialtype]": "tissue", "characteristics[label]": "TMT126", "characteristics[cleavageagent]": "Trypsin", "characteristics[modification]": "Oxidation", "characteristics[modification].1": "Carbamidomethyl", "comment[instrument]": "Q Exactive Plus", "comment[fractionidentifier]": "24", "comment[fractionationmethod]": "high pH reverse phase", "comment[precursormasstolerance]": "10 ppm", "comment[fragmentmasstolerance]": "0.05 Da", "comment[fragmentationmethod]": "HCD", "comment[acquisitionmethod]": "DDA", "characteristics[biologicalreplicate]": "1"}}
 
Example 2 — Label-free, phosphoproteomics, breast cancer, cell line + tissue:
{{"characteristics[organism]": "Homo sapiens", "characteristics[organismpart]": "breast", "characteristics[sex]": "female", "characteristics[age]": "50-74Y", "characteristics[developmentalstage]": "adult", "characteristics[disease]": "Triple-negative breast cancer", "characteristics[cellline]": "HCC38", "characteristics[materialtype]": "tissue", "characteristics[label]": "label free sample", "characteristics[cleavageagent]": "Trypsin", "characteristics[cleavageagent].1": "Lys-C", "characteristics[modification]": "Carbamidomethyl", "characteristics[modification].1": "Oxidation", "characteristics[modification].2": "Acetyl", "characteristics[modification].3": "Phospho", "comment[instrument]": "LTQ Orbitrap Elite", "comment[fragmentationmethod]": "CID", "comment[collisionenergy]": "35% NCE", "comment[ms2massanalyzer]": "Orbitrap", "comment[enrichmentmethod]": "enrichment of phosphorylated Protein", "comment[precursormasstolerance]": "20 ppm", "comment[acquisitionmethod]": "DDA", "characteristics[biologicalreplicate]": "1"}}
 
Example 3 — Label-free, plasma, high-abundance depletion, multiple time points:
{{"characteristics[organism]": "Homo sapiens", "characteristics[organismpart]": "blood plasma", "characteristics[sex]": "female", "characteristics[disease]": "obesity", "characteristics[disease].1": "normal", "characteristics[depletion]": "depleted fraction", "characteristics[samplingtime]": "-8W", "characteristics[materialtype]": "plasma", "characteristics[label]": "label free sample", "characteristics[cleavageagent]": "Trypsin", "characteristics[cleavageagent].1": "Lys-C", "characteristics[modification]": "Carbamidomethyl", "characteristics[modification].1": "Oxidation", "characteristics[modification].2": "Acetyl", "comment[instrument]": "Q Exactive HF", "comment[fragmentationmethod]": "HCD", "comment[collisionenergy]": "27 NCE", "comment[ms2massanalyzer]": "Orbitrap", "comment[acquisitionmethod]": "DDA", "comment[separation]": "Reversed-phase chromatography", "comment[fractionationmethod]": "no fractionation", "comment[precursormasstolerance]": "7 ppm", "comment[fragmentmasstolerance]": "20 ppm", "characteristics[biologicalreplicate]": "1"}}
 
Now extract from the paper above. Return only the JSON object. No other text."""
